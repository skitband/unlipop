&nbsp;&nbsp; 
 ...
 <a class="navbar-brand mr-1" href="index.html"><img class="img-fluid" alt="" src="{{asset('img/unlipop-logo.png')}}" style="width: 55px; height: 45px;"> <span style="color: #fff">UnliPoP</span></a>
 <!-- Navbar Search -->
