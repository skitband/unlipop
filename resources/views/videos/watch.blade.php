               ...
               <div class="single-video-left">
                  <div class="single-video">
                     <div class="plyr__video-embed" id="player">
                        <iframe width="1070" height="550" src="{{$video->src}}" frameborder="0" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen style="width: 1050px;height: 550px;"></iframe>
                        <!-- <iframe src="https://player.vimeo.com/video/309611839" width="640" height="480" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> -->
                     </div>
                  </div>
                  <div class="single-video-title box mb-3">
                     <h2>{{title_case($video->title)}}</h2>
                     <p class="mb-0"><i class="fas fa-eye"></i> {{number_format($video->views)}} views</p>
                  </div>
                  ...
                  <div class="single-video-info-content box mb-3">
                     <h6>Cast :</h6>
                     <p>{{title_case($video->cast)}}</p>
                     <h6>Description :</h6>
                     <p>{{title_case($video->description)}}</p>
                     <h6>Tags :</h6>
                     <p class="tags mb-0">
